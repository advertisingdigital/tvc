...
<div id="wrap" class="clearfix">
  ...
  <div id="main" class="clearfix">
    ...
    <?php if (theme_get_setting('slideshow_display','clean_theme')): ?>
      ...
      $slide1_url = check_plain(theme_get_setting('slide1_url','clean_theme')); 
      $slide2_url = check_plain(theme_get_setting('slide2_url','clean_theme')); 
      $slide3_url = check_plain(theme_get_setting('slide3_url','clean_theme')); 
      ?>
   <div id="slider-wrap">
    <div id="home-slides" class="slides clearfix">
      <div class="slides_container">
        <div class="slide">
           <a href="<?php echo $slide1_url ?>" target ="_blank"><img src="<?php print base_path() . drupal_get_path('theme', 'clean_theme') . '/images/slide-image-1.jpg'; ?>" height="350" width="660"/></a>
        ...
        <div class="slide">
           <a href="<?php echo $slide2_url ?>" target ="_blank"><img src="<?php print base_path() . drupal_get_path('theme', 'clean_theme') . '/images/slide-image-2.jpg'; ?>" height="350" width="660"/></a>
  ...
  <?php if ($slide3_url): ?>
        <div class="slide">
           <a href="<?php echo $slide3_url ?>" target ="_blank"><img src="<?php print base_path() . drupal_get_path('theme', 'clean_theme') . '/images/slide-image-3.jpg'; ?>" height="350" width="660"/></a>
