...
function clean_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['clean_settings']['slideshow']['slide1']['slide1_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Url'),
    '#default_value' => theme_get_setting('slide1_url','clean_theme'),
  );
  ...
  $form['clean_settings']['slideshow']['slide2']['slide2_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Url'),
    '#default_value' => theme_get_setting('slide2_url','clean_theme'),
  );
  ...
  $form['clean_settings']['slideshow']['slide3']['slide3_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide Url'),
    '#default_value' => theme_get_setting('slide3_url','clean_theme'),
  );
